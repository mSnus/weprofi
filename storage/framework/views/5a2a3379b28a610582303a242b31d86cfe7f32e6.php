...
<?php $__env->startSection('title', 'Починим.Онлайн'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container d-flex justify-content-center section-welcome">
        ...
        <?php if(!Auth::user() || Auth::user()->isClient()): ?>
            ...
            <?php else: ?>
                <?php echo $__env->make('requests', ['password_required' => true], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <?php endif; ?>
        <?php else: ?>
            <div class="flex shadow p-3 mb-5 bg-white rounded">
                ...
                <?php if(Auth::user()->isMaster()): ?>
                    <?php echo $__env->make('/masters_home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>;
                <?php endif; ?>
            </div>
        <?php endif; ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/admin/web/pochinim.online/public_html/app/resources/views/welcome.blade.php ENDPATH**/ ?>