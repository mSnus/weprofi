    ...
    <div id="app">
        <div class="head-wrapper">
			  ...
			  <div class="container">
				  ...
				  <div class="d-flex head-texts"  style="margin-top: 43px">
								  <div class="head-text1" style="padding-right: 40px"><img src="/img/text1.png"></div>
								  <div class="head-text2" style="padding-right: 40px"><img src="/img/text2.png"></div>
								  <div class="head-text3"><img src="/img/text3.png"></div>
				  </div>
				  @if ($rand == 0)
